...
class MainWindow(Adw.ApplicationWindow):
    ...
    def _create_row(self, snippet, is_inbox):
        ...
        if not is_inbox:
             ...
             link_btn.set_tooltip_text("Open in Browser")
             link_btn.connect("clicked", lambda b: self._open_browser(snippet['pastebin_url']))
    ...
    def _open_browser(self, url):
        try:
            ...
            self.toast_overlay.add_toast(Adw.Toast.new("Failed to open browser"))

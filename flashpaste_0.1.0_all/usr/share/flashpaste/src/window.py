...
class MainWindow(Adw.ApplicationWindow):
    def __init__(self, app):
        ...
        inbox_page = Adw.StatusPage()
        inbox_page.set_title("Inbox")
        inbox_page.set_child(self._create_scrolled(self.inbox_list))
        ...
        published_page = Adw.StatusPage()
        published_page.set_title("Published")
        published_page.set_child(self._create_scrolled(self.published_list))
